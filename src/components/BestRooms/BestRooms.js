	...
	return (
		<div className="bg-gray-100 dark:bg-gray-800">
			<div className="container mx-auto p-2 w-full md:w-8/12">
				<p className="font-thin  text-gray-500 text-center pt-8 bottom-line dark:text-gray-300">LUXURY ROOMS</p>
				<h2 className="text-5xl font-thin text-center py-5 mb-5 dark:text-gray-200">BEST ROOMS</h2>
				<div className="grid grid-cols-1 md:grid-cols-2 gap-4 pt-6 pb-12">
					<div className="w-full h-full">
						...
						<div className="bg-white p-6 dark:bg-gray-600">
							<h3 className="text-3xl font-thin mb-3 dark:text-gray-100">Small Room</h3>
							...
							<p className="font-thin text-gray-500 my-3 dark:text-gray-200">
								Lorem ipsum dolor sit amet consectetur adipisicing elit. Qui voluptatibus dolores nemo
								inventore placeat
							</p>
							<Link to="/rooms">
								<button className="bg-black flex text-white px-6 py-3 font-medium ">
									Explore Rooms
								</button>
							</Link>
						</div>
						...
						<div className="grid grid-cols-2 gap-4">
							<div className="overlay">
								...
								<p className="overlay-text ">
									...
									<span className="bg-yellow-500 hidden md:inline-block p-1 rounded ml-3">
										FROM $25
									</span>
								</p>
							</div>
