		...
		<div className="grid grid-cols-3 gap-14">
			<div className=" border-2 border-solid rounded-xl shadow-2xl mb-2">
				<img
					...
					alt=""
				/>
				<h3 className="text-2xl font-bold my-2 border-b-2 border-solid pb-2 pl-2 text-gray-700">Single Room</h3>
				<p className="p-2 text-gray-600 font-medium">
					Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quisquam commodi a beatae perferendis
					aliquam atque quia. Commodi quos eius repudiandae.
				</p>
			...
			<div className=" border-2 border-solid rounded-xl shadow-2xl mb-2">
				<img
					...
					alt=""
				/>
				<h3 className="text-2xl font-bold my-2 border-b-2 border-solid pb-2 pl-2 text-gray-700">Couple Room</h3>
				<p className="p-2 text-gray-600 font-medium">
					Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quisquam commodi a beatae perferendis
					aliquam atque quia. Commodi quos eius repudiandae.
				</p>
			...
			<div className=" border-2 border-solid rounded-xl shadow-2xl mb-2">
				<img
					...
					alt=""
				/>
				<h3 className="text-2xl font-bold my-2 border-b-2 border-solid pb-2 pl-2 text-gray-700">Family Room</h3>
				<p className="p-2 text-gray-600 font-medium">
					Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quisquam commodi a beatae perferendis
					aliquam atque quia. Commodi quos eius repudiandae.
				</p>
