				...
				<div className="container mx-auto p-2 md:w-9/12">
					<div className="grid grid-cols-1 md:grid-cols-5 gap-4 my-8">
						...
						<div className="col-span-3">
							{/* Name */}
							<h2 className="text-2xl md:text-4xl text-center font-medium dark:text-gray-100">{name}</h2>
							{/* Rattings */}
							<p className="font-thin md:text-lg mt-3 dark:text-gray-300">Rattings : </p>
							...
							{/* Room details */}
							<div className="grid grid-cols-3 divide-x-2 divide-gray-500 border-b-2 border-gray-200 mb-4 dark:text-gray-200">
							...
							{/* Description */}
							<div className="border-b-2 border-gray-200 pb-3 mb-4 dark:text-gray-200">
								<p className="text-justify text-lg ">{description}</p>
							</div>

							{/* Rooms services */}
							<div>
								<h2 className="text-2xl dark:text-gray-100 ">Room Services</h2>
								<div className="grid grid-cols-3 gap-4 mt-4 dark:text-gray-200">
									<div className="flex">
						...
						<div className="col-span-2">
							<div>
								<h2 className="text-3xl dark:text-gray-100">Select Your Booking Date</h2>
								<DatePicker />
								<button className="bg-black flex  text-white my-6 px-6 py-3 font-medium ">
									Book Now
								</button>
							</div>
